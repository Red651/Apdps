...
from app.core.external.pages.sections.pred_clus import upload_train
...
dash.register_page(__name__, path="/machine-learning/pred_clus")
                            ...
                            dmc.Stack(
                                [
                                    ...
                                    dmc.Modal(
                                        ...
                                        id='predclus-reset-modal',
                                        children=[
                                            dmc.Flex(
                                                dmc.Button("Yes, reset", color="red", variant="filled", id='predclus-reset-button', n_clicks=0),
                                                justify="end",
                                            )
                                        ]
                                    ),
...
@callback(
    Output("predclus-reset-modal", "opened"),
    Input("predclus-toggle-reset-modal", "n_clicks"),
    State("predclus-reset-modal", "opened"),
    prevent_initial_call=True
)
...
@callback(
    ...
    Input("predclus-go-back-button", "n_clicks"),
    prevent_initial_call=True
)
...
@callback(
    ...
    Input("predclus-reset-button", "n_clicks"),
    State("url", "pathname"),
    prevent_initial_call=True,
)
...
@callback(
    Output("predclus-stepper", "active", allow_duplicate=True),
    Output("predclus-content", "children"),
    Input("predclus-next-button", "n_clicks"),
    State("predclus-stepper", "active"),
    prevent_initial_call=True,
)
