...
dash.register_page(__name__, path='/machine-learning/clusterin')

from app.core.external.pages.sections.clustering import feature_selection, model_training, upload_data, data_preprocessing, model_export, prediction
