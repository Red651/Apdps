...
from app.core.external.pages.sections.clustering.utils import parse_validation_errors, session_get_file_path, continue_button, reset_button
...
def layout():
    ...
    layout = dmc.Stack(
        [
            ...
            dmc.Button("Download", color="green", id='clustering-apply_scaler_export', n_clicks=0),
            html.Div(id="clustering-sessSchem-export-output"),
            dcc.Download(id="clustering-download-sessSchem"),
            dmc.Group(
                [
                    reset_button,
                    html.Div(
...
@callback(
    Output("clustering-sessSchem-export-output", "children"),
    Output("clustering-download-sessSchem", "data"),
    Input('clustering-apply_scaler_export', 'n_clicks'),
