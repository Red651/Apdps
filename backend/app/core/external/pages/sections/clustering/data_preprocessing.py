...
from app.core.external.pages.sections.clustering.utils import parse_validation_errors, create_table_description, session_get_file_path, session_df_to_file, continue_button, reset_button, session_dict_to_json, session_schema_create, session_schema_save, session_scaler_save
...
def preprocess_all_and_visualize(df: pd.DataFrame, column_schemas, preprocessed_file_name='preprocessed'):
    ...
    if len(numeric_cols) > 1:
        ...
        num_cols_copy = [col.replace(' ', '<br>') for col in numeric_cols]
...
def create_form(column):
    ...
    form = dmc.Stack(
        [
            dmc.Select(
                id={'class':'clutering', 'type':"missing_value_handling", 'column': column},
            ...
            dmc.NumberInput(
                id={'class':'clutering', 'type':"custom_value", 'column': column},
                label="Custom Value",
                description="Custom value for filling missing data, used if missing_value_handling is 'custom'",
                value=0,
                required=False,
            ...
            dmc.Select(
                id={'class':'clutering', 'type':"scaling_method", 'column': column},
            ...
            dmc.Select(
                id={'class':'clutering', 'type':"outlier_handling", 'column': column},
            ...
            dmc.NumberInput(
                id={'class':'clutering', 'type':"cap_value", 'column': column},
                label="Cap Value",
                description="Value to cap outliers, used if outlier_handling is 'cap'",
                value=0,
                required=False,
    ...
    return dmc.Stack(
        [
            form,
            dmc.Flex(
                dmc.Button("Apply", color="blue", id={'class':'clutering', 'type': 'numeric', 'column': column}, n_clicks=0, w=200),
                justify="end",
            ),
            html.Div(id={'class':'clutering', 'type': "output", 'column': column}),
        ]
    )
...
def create_form_labeled(column):
    ...
    form = dmc.Stack(
        [
            dmc.Select(
                id={'class':'clutering', 'type':"label_missing_value_handling", 'column': column},
                label="Missing Value Handling",
                description="Method for handling missing values",
                data=[
                    {"label": "Remove", "value": "remove"},
            ...
            dmc.NumberInput(
                id={'class':'clutering', 'type':"label_custom_value", 'column': column},
                label="Custom Value",
                description="Custom value for filling missing data, used if missing_value_handling is 'custom'",
                value=0,
                required=False,
            ...
            dmc.Select(
                id={'class':'clutering', 'type':"label_encoding_method", 'column': column},
    ...
    return dmc.Stack(
        [
            form,
            dmc.Flex(
                dmc.Button("Apply", color="blue", id={'class':'clutering', 'type': 'label', 'column': column}, n_clicks=0, w=200),
                justify="end",
            ),
            html.Div(id={'class':'clutering', 'type': "label-output", 'column': column}),
        ]
    )
...
def layout():
    ...
    layout = dmc.Stack(
        [
            ...
            tabs,
            dmc.Button("Apply All Preprocessing", color="green", id='clutering-apply_preprocessing', n_clicks=0),
            dcc.Loading(type='circle',id='clutering-loading-preproccess_data',style={"width": "80px", "height": "80px"}),
            html.Div(id="clutering-output"),
            dmc.Group(
                [
                    reset_button,
                    html.Div(
                        id='clutering-proceed-output',
                    )
                ],
...
@callback(
    Output({'class':'clutering', 'type': "custom_value", 'column': MATCH}, 'display'),
    Input({'class':'clutering', 'type': "missing_value_handling", 'column': MATCH}, 'value'),
...
@callback(
    Output({'class':'clutering', 'type': "label_custom_value", 'column': MATCH}, 'display'),
    Input({'class':'clutering', 'type': "label_missing_value_handling", 'column': MATCH}, 'value'),
    prevent_initial_call=True
)
...
@callback(
    Output({'class':'clutering', 'type': "cap_value", 'column': MATCH}, 'display'),
    Input({'class':'clutering', 'type': "outlier_handling", 'column': MATCH}, 'value'),
    prevent_initial_call=True
)
...
@callback(
    Output({'class':'clutering', 'type': "label-output", 'column': MATCH},'children'),
    Input({'class':'clutering', 'type': "label", 'column': MATCH}, 'n_clicks'),
    State({'class':'clutering', 'type': 'label_missing_value_handling', 'column': MATCH}, 'value'),
    State({'class':'clutering', 'type': 'label_custom_value', 'column': MATCH}, 'value'),
    State({'class':'clutering', 'type': 'label_encoding_method', 'column': MATCH}, 'value'),
    State({'class':'clutering', 'type': "label", 'column': MATCH}, 'id'),
    prevent_initial_call=True
)
...
@callback(
    Output({'class':'clutering', 'type': "output", 'column': MATCH},'children'),
    Input({'class':'clutering', 'type': "numeric", 'column': MATCH}, 'n_clicks'),
    State({'class':'clutering', 'type': 'missing_value_handling', 'column': MATCH}, 'value'),
    State({'class':'clutering', 'type': 'custom_value', 'column': MATCH}, 'value'),
    State({'class':'clutering', 'type': 'scaling_method', 'column': MATCH}, 'value'),
    State({'class':'clutering', 'type': 'outlier_handling', 'column': MATCH}, 'value'),
    State({'class':'clutering', 'type': 'cap_value', 'column': MATCH}, 'value'),
    State({'class':'clutering', 'type': "numeric", 'column': MATCH}, 'id'),
)
...
@callback(
    Output("clutering-output", "children"),
    Output("clutering-proceed-output", "children", allow_duplicate=True),
    Output('clutering-loading-preproccess_data','children', allow_duplicate=True),
    Input('clutering-apply_preprocessing', 'n_clicks'),
    State({'class':'clutering', 'type': 'missing_value_handling', 'column': ALL}, 'value'),
    State({'class':'clutering', 'type': 'custom_value', 'column': ALL}, 'value'),
    State({'class':'clutering', 'type': 'scaling_method', 'column': ALL}, 'value'),
    State({'class':'clutering', 'type': 'outlier_handling', 'column': ALL}, 'value'),
    State({'class':'clutering', 'type': 'cap_value', 'column': ALL}, 'value'),
    State({'class':'clutering', 'type': 'label_missing_value_handling', 'column': ALL}, 'value'),
    State({'class':'clutering', 'type': 'label_custom_value', 'column': ALL}, 'value'),
    State({'class':'clutering', 'type': 'label_encoding_method', 'column': ALL}, 'value'),
    State({'class':'clutering', 'type': "numeric", 'column': ALL}, 'id'),
    State({'class':'clutering', 'type': "label", 'column': ALL}, 'id'),
    prevent_initial_call = True
)
