...
from app.core.external.pages.sections.classification.utils import parse_validation_errors, create_table_description, session_get_file_path, session_df_to_file, continue_button, reset_button, session_dict_to_json, session_schema_create, session_schema_save
...
def layout():
    ...
    layout = dmc.Stack(
        [
            ...
            dcc.Loading(type='circle',id='classification-loading-preproccess_data',style={"width": "80px", "height": "80px"}),
...
@callback(
    ...
    Output('classification-loading-preproccess_data','children', allow_duplicate=True),
