...
from app.core.external.pages.sections.regression.utils import parse_validation_errors, session_get_file_path, continue_button, reset_button
...
def layout():
    ...
    layout = dmc.Stack(
        [
            ...
            dmc.Button("Download", color="green", id='regression-apply_scaler_export', n_clicks=0),
            html.Div(id="regression-sessSchem-export-output"),
            dcc.Download(id="regression-download-sessSchem"),
            dmc.Group(
                [
                    reset_button,
                    html.Div(
...
@callback(
    Output("regression-sessSchem-export-output", "children"),
    Output("regression-download-sessSchem", "data"),
    Input('regression-apply_scaler_export', 'n_clicks'),
