...
dash.register_page(__name__, path='/machine-learning/regression')

from app.core.external.pages.sections.regression import feature_selection, model_training, upload_data, data_preprocessing, model_export, prediction
