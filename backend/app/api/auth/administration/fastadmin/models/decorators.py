...
def register(*orm_model_classes, **kwargs):
    ...
    """
    from app.api.auth.administration.fastadmin.models.base import ModelAdmin
    from app.api.auth.administration.fastadmin.models.helpers import register_admin_model_class
...
def register_widget(dashboard_widget_admin_cls):
    ...
    """
    from app.api.auth.administration.fastadmin.models.base import DashboardWidgetAdmin, admin_dashboard_widgets
