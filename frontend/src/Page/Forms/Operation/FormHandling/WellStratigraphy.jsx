...
const WellStratigraphyForm = () => {
  ...
  const data = state?.initialOperationData?.actual_job?.well.well_stratigraphy;
  const unittype =
    state?.initialOperationData?.actual_job?.well?.unit_type || "METRICS";
  const depthDatum =
    state?.initialOperationData?.actual_job?.well?.depth_datum || "RT";
