...
const JobDetail = ({errorForms = {}}) => {
    ...
    const initializeFormData = useCallback(() => {
        if (state?.initialOperationData?.actual_job?.well) {
            ...
            const newData = {
                ...
                well_level_type: wellData.well_level_type || null,
            };
            setFormData(newData);
    ...
    }, [formData, initialData, state.initialOperationData, dispatch]);
            ...
            <Box borderWidth="1px" borderRadius="lg" p={6}>
              ...
              {errorForms["job_plan.well.uwi"] && (
                <FormErrorMessage>UWI is required</FormErrorMessage>
                        ...
                        <FormControl isInvalid={!!localErrorForms["well.well_name"]}>
                            ...
                            />
                            {localErrorForms["well.well_name"] && (
                                <FormErrorMessage>{localErrorForms["well.well_name"]}</FormErrorMessage>
                            )}
                        </FormControl>
                    </HStack>
                    <HStack spacing={4}>
                        <FormControl isInvalid={!!localErrorForms["well.well_num"]}>
                            <HeaderForm
                                title={"Well Num"}
                                desc={
                            ...
                            />
                            {localErrorForms["well.well_num"] && (
                                <FormErrorMessage>{localErrorForms["well.well_num"]}</FormErrorMessage>
                            )}
                        </FormControl>
                        <FormControl isInvalid={!!localErrorForms["well.well_class"]}>
                            <HeaderForm
                                title={"Well Class"}
                            ...
                            {localErrorForms["well.well_class"] && (
                                <FormErrorMessage>{localErrorForms["well.well_class"]}</FormErrorMessage>
                            )}
                        </FormControl>
                    </HStack>
                    <HStack spacing={4}>
                        <FormControl
                            isInvalid={!!localErrorForms["well.well_profile_type"]}
                        >
                            <HeaderForm
                            ...
                            {localErrorForms["well.well_profile_type"] && (
                                <FormErrorMessage>
                                    {localErrorForms["well.well_profile_type"]}
                                </FormErrorMessage>
                            )}
                        ...
                        <FormControl
                            isInvalid={!!localErrorForms["well.environment_type"]}
                        >
                            <HeaderForm
                            ...
                            {localErrorForms["well.environment_type"] && (
                                <FormErrorMessage>
                                    {localErrorForms["well.environment_type"]}
                                </FormErrorMessage>
                            )}
                    ...
                    <HStack spacing={4}>
                        <FormControl>
                            <FormControl isInvalid={!!localErrorForms["well.well_level_type"]}>
                                <HeaderForm
                                ...
                                {localErrorForms["well.well_level_type"] && (
                                    <FormErrorMessage>
                                        {localErrorForms["well.well_level_type"]}
                                    </FormErrorMessage>
                                )}
                    ...
                    <HStack>
                        <FormControl isInvalid={!!localErrorForms["well.parent_well_id"]}>
                            <HeaderForm
                                title={"Parent Well"}
                                desc={
                            ...
                            <ChakraSelect
                                ...
                                isSearchable
                            />
                            {localErrorForms["well.parent_well_id"] && (
                                <FormErrorMessage>
                                    {localErrorForms["well.parent_well_id"]}
                                </FormErrorMessage>
                            )}
