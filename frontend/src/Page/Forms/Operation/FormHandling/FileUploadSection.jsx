...
const FileUploadSection = ({
  ...
  const currentData = useMemo(() => {
    return parentPath
      ? state?.initialOperationData?.actual_job?.[parentPath]?.[variableName]
      : state?.initialOperationData?.actual_job?.[variableName];
  }, [state?.initialOperationData, parentPath, variableName]);
  ...
  useEffect(() => {
    ...
    const updateGlobalState = () => {
      ...
      if (parentPath) {
        newPayload.actual_job[parentPath] = {
          ...newPayload.actual_job[parentPath],
          [variableName]: formData,
        };
      } else {
        newPayload.actual_job[variableName] = formData;
      }
