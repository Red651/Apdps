...
const DocProjSummary = ({onChangeOnData = (name,data) => console.log(name,data)}) => {
  ...
  React.useEffect(()=> {
    onChangeOnData('dokumen_project_summary',data)
  },[data])
  ...
  const renderUpload = () => {
    return <Button colorScheme={color} leftIcon={icon} p="18px" onClick={uploadFIle}>
    Upload
  </Button>
  };
  return (
