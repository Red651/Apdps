...
import { IconButton, Tooltip, UnorderedList, ListItem } from "@chakra-ui/react";
  ...
  useEffect(() => {
    ...
    try {
      const fetchData = async () => {
        const data = await getTableKKKS(kkks_id, "wellservice", "plan");
        setTableData(data.data);
      };

      const fetchCountData = async () => {
        const data = await getCountDataSummary(kkks_id, "wellservice", "plan");
...
export default PlanningWellServiceKKKS;
