...
import { GetViewPlanning } from "../../API/APISKK";
...
import { RESET_JOB_PLAN_EXP_DEV, RESET_STATE } from "../../../Reducer/reducer";
...
const PlanningExpKKKS = () => {
  ...
  useEffect(() => {
    ...
    try {
      const fetchData = async () => {
        const data = await getTableKKKS(kkks_id, "exploration", "plan");
        setTableData(data.data);
      };

      const fetchCountData = async () => {
        const data = await getCountDataSummary(kkks_id, "exploration", "plan");
  ...
  const handleOperate = async () => {
    ...
    try {
      ...
      const updatedData = await getTableKKKS(kkks_id, "exploration", "plan");
