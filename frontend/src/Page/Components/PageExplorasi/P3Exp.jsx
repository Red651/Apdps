...
const PPPExplorationKKKS = () => {
  ...
  useEffect(() => {
    ...
    try {
      const fetchData = async () => {
        const data = await getTableKKKS(kkks_id, "exploration", "ppp");
        setTableData(data.data);
      };

      const fetchCountData = async () => {
        const data = await getCountDataSummary(kkks_id, "exploration", "ppp");
  ...
  const handleOperate = async () => {
    ...
    try {
      ...
      const updatedData = await getTableKKKS(kkks_id, "exploration", "p3");
                ...
                <Flex gap={2}>
                  ...
                  <Tooltip label="View">
                    <IconButton
                      ...
                      size="sm"
                      as={Link}
                      to={`/exploration/operation/view/${jobs.job_id}/`}
...
export default PPPExplorationKKKS;
