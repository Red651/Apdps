    ...
    <VStack spacing={6} align="stretch" fontFamily={"Mulish"}>
      <Box borderWidth="1px" borderRadius="lg" p={6}>
        ...
        <VStack spacing={4} align="stretch" mt={5}>
          ...
          <HStack spacing={4}>
            <FormControl
              isInvalid={!!errorForms["job_plan.well.well_num"]}
            >
              <FormLabel>Well Num</FormLabel>
              <Input
                name="well_num"
              ...
              />
              {errorForms["job_plan.well.well_num"] && (
                <FormErrorMessage>Well Num is required</FormErrorMessage>
              )}
            </FormControl>
            <FormControl isInvalid={!!errorForms["job_plan.well.well_class"]}>
              ...
              {errorForms["job_plan.well.well_class"] && (
          ...
          <HStack spacing={4}>
            <FormControl>
              <FormControl
                isInvalid={!!errorForms["job_plan.well.well_num"]}
              >
                <FormLabel>Well Level Type</FormLabel>
                <Select
                ...
                {errorForms["job_plan.well.well_level_type"] && (
                  <FormErrorMessage>
          ...
          <HStack>
            <FormControl>
              <FormLabel>Parent Well</FormLabel>
              <ChakraSelect
                name="parent_well_id"
