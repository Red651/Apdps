...
const OperationWorkOverKKKS = () => {
  ...
  useEffect(() => {
    ...
    try {
      const fetchData = async () => {
        const data = await getTableKKKS(kkks_id, "workover", "operation");
  ...
  const handleOperate = async () => {
    ...
    try {
      ...
      const updatedData = await getTableKKKS(kkks_id, "workover", "operation");
                ...
                <Flex gap={2}>
                  ...
                  <Tooltip label="View">
                    <IconButton
                      ...
                      size="sm"
                      as={Link}
                      to={`/development/planning/view/${jobs.job_id}/`}
                      icon={<Icon as={IconEye} />}
                      rounded="full"
                      aria-label="View"
                    />
...
export default OperationWorkOverKKKS;
