...
const PPPDev = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        setLoading(true);
        const data = await getJobPhase("development", "ppp");
    ...
    const getProgress = async () => {
      try {
        const data = await getProgressSKK("development", "ppp");
        ...
        actionButtons={(jobs) => (
          ...
          {jobs.STATUS === "APPROVED" ? (
            <Button
              ...
              size="sm"
              as={Link}
              to={`/skk/development/ppp/view/${jobs.job_id}`}
            ...
            <Button
              ...
              size="sm"
              as={Link}
              to={`/skk/development/ppp/validate/${jobs.job_id}`}
