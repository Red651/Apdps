...
const PPPWO = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        setLoading(true);
        const data = await getJobPhase("workover", "ppp");
    ...
    const getProgress = async () => {
      try {
        const data = await getProgressSKK("workover", "ppp");
        ...
        actionButtons={(jobs) => (
          ...
          {jobs.STATUS === "APPROVED" ? (
            <Button
              ...
              size="sm"
              as={Link}
              to={`/skk/workover/ppp/view/${jobs.job_id}`}
            ...
            <Button
              ...
              size="sm"
              as={Link}
              to={`/skk/workover/ppp/validate/${jobs.job_id}`}
            ...
            <Button
              ...
              size="sm"
              as={Link}
              to={`/skk/workover/operating/view/${jobs.job_id}`}
              leftIcon={<Icon as={IconEye} />}
              rounded="full"
              aria-label="View"
            >
